...
<template>
    ...
    <div class="container px-6 py-6 mx-auto lg:flex lg:items-center lg:justify-between">
      <div class="flex items-center justify-between ">
        <a class="flex items-center -mx-1" href="#">
          <svg class="w-8 h-8 mx-1 sm:h-15 sm:w-15" xmlns="http://www.w3.org/2000/svg"
            xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 192 192" xml:space="preserve">
            <path fill="#475F45" opacity="1.000000" stroke="none" d="
                M91.468269,193.000000 
                	C86.503502,190.565552 81.359299,190.762695 76.558418,189.523590 
                	C43.174221,180.907104 16.060595,150.659805 10.553082,116.556351 
                	C3.499571,72.879799 27.192333,33.684219 62.593372,17.583931 
                	C113.745995,-5.680128 174.966934,21.726757 189.574875,77.154274 
                	C190.979721,82.484711 191.506302,87.932220 192.898483,93.626122 
                	C193.000000,97.692909 193.000000,101.385818 192.907379,105.923218 
                	C192.660263,107.579948 192.451767,108.386063 192.359024,109.205284 
                	C188.458527,143.661209 170.905289,168.555481 139.985535,184.139496 
                	C130.514420,188.913086 120.140717,190.540970 110.000000,193.000000 
                	C103.978844,193.000000 97.957695,193.000000 91.468269,193.000000 
                M71.803963,178.648422 
                	C86.490669,184.277679 101.752373,185.432739 116.953918,182.391678 
                	C162.334335,173.313293 196.416199,126.650345 179.695267,75.390457 
                	C161.549194,19.761658 95.352905,1.170985 51.626858,34.763546 
                	C23.199816,56.602634 12.827708,85.833427 20.608498,120.490456 
                	C26.865086,148.358414 44.963650,167.190414 71.803963,178.648422 
                z" />
            <path fill="#475F45" opacity="1.000000" stroke="none" d="
                M82.159470,125.711594 
                	C84.593903,125.634186 86.621300,125.743675 88.575607,125.416550 
                	C91.986542,124.845604 94.296562,125.974518 94.753937,129.440445 
                	C95.206268,132.868134 93.112190,134.712021 89.901413,135.214905 
                	C75.367027,137.491318 63.185928,133.192902 54.078613,121.545883 
                	C44.364616,109.123001 44.244694,91.382042 53.360287,78.652939 
                	C62.529331,65.849190 79.062820,60.440434 94.145973,65.310341 
                	C109.295540,70.201691 119.458061,84.238297 119.234917,100.082642 
                	C119.173622,104.434799 118.215096,108.651978 116.734306,112.741074 
                	C115.592285,115.894676 113.560570,118.147377 109.991875,117.071144 
                	C106.267670,115.948029 106.104408,112.778725 107.174309,109.697998 
                	C109.088936,104.184937 109.516838,98.557480 108.067177,93.007957 
                	C104.649521,79.924522 92.139954,72.101166 78.606911,74.246414 
                	C65.388084,76.341858 56.617908,87.674942 57.245708,101.850014 
                	C57.803391,114.441856 68.381027,124.750702 82.159470,125.711594 
                z" />
            <path fill="#475F45" opacity="1.000000" stroke="none" d="
                M145.678772,107.524544 
                	C150.753174,88.881226 136.559677,71.695625 117.964142,73.597389 
                	C114.349144,73.967094 111.286072,73.512970 110.875275,69.444641 
                	C110.430283,65.037575 113.725937,63.938969 117.384415,63.698242 
                	C138.910202,62.281868 156.216400,76.717995 157.011414,98.237061 
                	C157.826340,120.294693 140.406647,135.984863 120.577835,135.546204 
                	C95.136978,134.983368 78.839394,111.490372 86.959122,87.342300 
                	C87.276764,86.397644 87.680801,85.477921 88.100327,84.572411 
                	C89.441101,81.678421 91.543663,79.774979 94.809685,81.151443 
                	C97.877289,82.444290 98.673553,85.039299 97.443451,88.209801 
                	C96.238609,91.315201 95.292625,94.444633 95.135056,97.858368 
                	C94.551834,110.494087 101.914139,121.097641 113.953560,124.650620 
                	C125.191353,127.967026 137.290649,122.975456 143.452301,112.424973 
                	C144.287216,110.995346 144.875107,109.421440 145.678772,107.524544 
                z" />
          </svg>

          <div class="mx-1 text-gray-700">
            <h3 class="uppercase tracking-[0.15em] font-medium ">Untukmu</h3>
            <p class="text-xs italic ">Your Invitation Solution</p>
          </div>
        </a>
      ...
      <div :class="[isOpen ? 'opacity-100 ' : 'opacity-0 -translate-x-full ']"
        ...
        <nav class="flex flex-col items-center space-y-8 lg:flex-row lg:space-y-0 lg:-mx-4">
          ...
          <a class="px-8 py-2.5 text-white lg:text-[#475F45] lg:hover:bg-[#475F45] lg:hover:text-white duration-300 transition-colors font-medium lg:mx-4 border-2 lg:border-[#475F45] border-white"
            href="#">Membership</a>
        </nav>
      </div>
    </div>
  ...
  <section class="container flex flex-col items-center px-6 py-6 mx-auto lg:flex-row">
    <div
      class="h-[38rem] w-full mx-auto max-w-md overflow-hidden rounded-xl outline outline-4 outline-offset-4 outline-[#475F45]/40">
      <div
        class="w-full h-full rounded-xl bg-cover bg-center bg-[url('https://source.unsplash.com/mOe4i_08DmU?fit=crop&crop=faces')]">
        <div class="flex h-full flex-col">
          <div class="grow h-12 text-center p-8">
            02
          </div>
    ...
    <div class="lg:w-1/2 lg:mt-0 mt-12">
      <h1 class="max-w-xl font-serif text-4xl font-medium tracking-wide text-[#343D33] capitalize md:text-6xl ">A beatiful
        adventure awaits</h1>

      <p class="max-w-lg mt-4 text-gray-500">Lorem ipsum dolor sit amet consectetur adipisicing elit. At magnam
        voluptatibus perferendis odit optio.</p>
  ...
  <section class="bg-[#343D33] mt-12">
    <div class="container flex flex-col px-6 py-16 mx-auto mt-12">
      <div class="order-2 mt-8 lg:order-1 lg:mt-0 lg:flex lg:items-center lg:-mx-6">
        ...
        <div class="mt-8 lg:w-1/2 lg:mx-6 lg:mt-0">
          ...
          <p class="mt-4 text-gray-200 ">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Quibusdam, nisi fugiat dicta impedit sed quisquam
            quas veritatis consectetur neque saepe, autem facilis dolore officiis minima explicabo perferendis ab porro
            magnam!
          </p>

          <a class="inline-flex px-6 py-3 mt-6 text-white border-2 border-white hover:bg-[#475F45] duration-300 transition-colors"
            href="#">
            Learn More
          </a>
        </div>
      ...
      <img class="order-1 object-cover lg:order-2 w-ful h-72 lg:h-96 lg:mt-12"
  ...
  <section class="container px-6 py-12 mx-auto lg:py-16">
    ...
    <div class="mt-8 xl:-mx-6 xl:flex">
      <div class="xl:w-1/2 xl:mx-6">
        ...
        <p class="mt-2 text-gray-500">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Tincidunt facilisis
          nuncLorem ipsum dolor sit.Lorem ipsum dolor sit amet, consectetur adipiscing elit...</p>
    ...
    <div class="container px-6 py-8 mx-auto space-y-8 lg:space-y-0 lg:flex lg:justify-between">
      <div>
        <a class="flex items-center -mx-2" href="#">
          <svg class="w-10 h-10 mx-2" width="48" height="48" viewBox="0 0 48 48" fill="none"
        ...
        <p class="max-w-lg mt-6 leading-relaxed text-white ">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Incidunt voluptatum amet molestiae consequatur quam
          velit sint modi aut illo dolorem.
        </p>
      </div>
  ...
  <full-page id="fullpage" ref="fullpage">
    <section class="container flex flex-col items-center px-6 py-6 mx-auto lg:flex-row">
      ...
      <div class="lg:w-1/2 lg:mt-0 mt-12">
        <h1 class="max-w-xl font-serif text-4xl font-medium tracking-wide text-[#343D33] capitalize md:text-6xl ">A
          beatiful
          adventure awaits</h1>
